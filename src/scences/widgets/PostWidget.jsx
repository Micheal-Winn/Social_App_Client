...
const PostWidget = ({
  ...
  const isLiked = Boolean(likes[loggedInUserId]); //type is Map so "id":"true" that checks whether id is true or false in database
    ...
    <WidgetWrapper m="2rem 0">
      ...
      {picturePath && (
        <img
          ...
          src={`http://localhost:8000/assets/Monterey-light.png`}///fix later
        />
      )}
